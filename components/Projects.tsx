      ...
      <div className="flex flex-col gap-4 mt-4 md:flex-row">
        {projects.project.map((item: any, index: number) => {
          return (
            <div
              key={index}
              className="p-6 pt-4 mb-4 transition-all border rounded-xl bg-lightCard border-opacity-20 border-neutral-700 dark:border-neutral-700 dark:bg-neutral-800 hover:drop-shadow-xl dark:hover:shadow-neutral-800 dark:shadow-lg"
            >
