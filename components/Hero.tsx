...
export default function Hero(): JSX.Element {
  ...
  return (
    <div className="mb-12">
      ...
      <span className="inline-block px-2 py-1 mt-16 text-sm font-medium leading-none text-center text-gray-700 align-baseline border rounded-lg whitespace-nowrap bg-lightCard border-opacity-20 border-greyBorder hover:bg-zinc-50 dark:hover:bg-neutral-700 dark:bg-neutral-800 dark:text-white ">
        <Link
